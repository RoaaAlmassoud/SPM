...
export default class DeleteSeriveProviderModal extends React.Component {
    ...
    delete = async () => {
        ...
        const response = await this.pageApi.deletePorviderService({ id: service.id })
        this.setState({ loading: false })
        if (response.data) {
            this.setState({ open: false })
            this.props.props.props.refresh()
